...
rocmfp4_decode_tune_known_profiles() {
    echo "stable, strix-moe-rpb1, strix-moe-rpb2, strix-moe-rpb3, strix-moe-rpb4, strix-nwarps1, strix-nwarps2, strix-nwarps4, strix-mmid3, strix-mmid4, rocmfpx-strix-moe-rpb1, rocmfpx-strix-moe-rpb2, rocmfpx-strix-moe-rpb3, rocmfpx-strix-moe-rpb4, rocmfpx-strix-nwarps1, rocmfpx-strix-nwarps2, rocmfpx-strix-nwarps4, rocmfpx-strix-rpb2, rocmfpx-strix-mmid3, rocmfpx-strix-mmid4, rocmfpx-strix-vdr2, rocmfpx-strix-vdr8"
}
